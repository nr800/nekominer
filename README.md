...
`https://github.com/nr800/nekominer/releases/latest/download/nekominer-hiveos.tar.gz`
...
```json
{
  ...
  "items": [{
    ...
    "miner_config": {
      ...
      "install_url": "https://github.com/nr800/nekominer/releases/latest/download/nekominer-hiveos.tar.gz",
...
- **os.dog package:** [`nekominer-osdog.tar.gz`](https://github.com/nr800/nekominer/releases/latest/download/nekominer-osdog.tar.gz)
